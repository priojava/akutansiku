            ...
            <div x-show="activeTab === 'goods'" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_inventory_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Persediaan --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_inventory_id ?? $defaultMap['account_inventory_id']) == $acc->id ? 'selected' : '' }}>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_sales_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Penjualan --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_sales_id ?? $defaultMap['account_sales_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_sales_return_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Retur Penjualan --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_sales_return_id ?? $defaultMap['account_sales_return_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_sales_discount_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Diskon Penjualan --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_sales_discount_id ?? $defaultMap['account_sales_discount_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_goods_in_transit_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Barang Terkirim --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_goods_in_transit_id ?? $defaultMap['account_goods_in_transit_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_cogs_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun HPP --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_cogs_id ?? $defaultMap['account_cogs_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_purchase_return_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Retur Pembelian --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_purchase_return_id ?? $defaultMap['account_purchase_return_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_expense_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Beban --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_expense_id ?? $defaultMap['account_expense_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition md:col-span-2">
                        ...
                        <select name="account_unbilled_purchases_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Pembelian Belum Tertagih --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_unbilled_purchases_id ?? $defaultMap['account_unbilled_purchases_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
            ...
            <div x-show="activeTab === 'finance'" class="space-y-5" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_receivable_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Piutang --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_receivable_id ?? $defaultMap['account_receivable_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_payable_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Hutang --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_payable_id ?? $defaultMap['account_payable_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_cash_drawer_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Kas Kasir --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_cash_drawer_id ?? $defaultMap['account_cash_drawer_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_rounding_diff_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun Selisih Kas --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_rounding_diff_id ?? $defaultMap['account_rounding_diff_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_sales_deposit_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun DP Penjualan --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_sales_deposit_id ?? $defaultMap['account_sales_deposit_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="p-3.5 bg-slate-50/60 rounded-xl border border-slate-200/70 hover:border-blue-300 transition">
                        ...
                        <select name="account_purchase_downpayment_id" class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih Akun DP Pembelian --</option>
                            @foreach($accounts as $acc)
                                <option value="{{ $acc->id }}" {{ ($settings->account_purchase_downpayment_id ?? $defaultMap['account_purchase_downpayment_id']) == $acc->id ? 'selected' : '' }}>
                                    {{ $acc->code }} - {{ $acc->name }} ({{ $acc->category }})
                                </option>
                            @endforeach
                        </select>
